        ...
        <flux:sidebar sticky collapsible
            ...
            <flux:sidebar.header>
                <flux:sidebar.brand href="#" logo="{{ asset('dark.mustagram.svg') }}"
                    logo:dark="{{ asset('light.mustagram.svg') }}" name="{{ __('home.app-name') }}" />
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    <flux:sidebar.item icon="home" :href="route('feed')" :current="request()->routeIs('feed')"
                        wire:navigate>{{ __('Feed') }}
                    </flux:sidebar.item>
                </flux:sidebar.group>
            </flux:sidebar.nav>
